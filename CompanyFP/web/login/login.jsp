		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
					...
					<!-- Start Sign In Form -->
					<form method="post" action="${pageContext.request.contextPath}/userController?action=login" class="fh5co-form animate-box" data-animate-effect="fadeIn">
						<h2>Sign In</h2>
						<div class="form-group">
							<label for="username" class="sr-only">Username</label>
                                                        <input name="emailId" type="text" class="form-control" id="username" placeholder="Email" autocomplete="off">
						</div>
						<div class="form-group">
							...
							<input name="password" type="password" class="form-control" id="password" placeholder="Password" autocomplete="off">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    Not registered? <a href="${pageContext.request.contextPath}/login/sign-up.jsp">Sign Up</a>
						</div>						
					</form>
					<!-- END Sign In Form -->
